<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MstCnvShohn.aspx.cs" Inherits="Kouri_Form.Master.MstCnvShohn" %>
        ...
        <div>
            <table id="example">
                <tr>
                    ...
                    <td>
                        <label id="lbl01" for="txtOrosiCd" >卸店コードの頭３桁(未入力可)</label>
                    </td>
                </tr>
                <tr>
                    <td style="text-align:right;">
